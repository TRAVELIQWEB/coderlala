                    ...
                    <div className="space-y-3">
                      {jobs.map((job, i) => (
                        <button
                          ...
                          className={`w-full text-left p-4 rounded-xl transition-all ${i === activeJob ? 'bg-white/10' : 'bg-white/5 hover:bg-white/10'}`}
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                              {/* FIXED: Proper icon rendering in list */}
                              {(() => {
          ...
          <div className="glass-card p-12 rounded-3xl backdrop-blur-xl border border-white/10 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              >
                ...
                <span className="relative">careers@coderlala.com</span>
              </Link>
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="p-4 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all"
                >
