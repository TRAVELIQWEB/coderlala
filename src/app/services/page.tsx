...
const services = [
  {
    ...
    features: ["Next.js/React", "TypeScript", "SEO Optimization", "PWA", "Performance Tuning"],
    projects: "150+",
    delivery: "4-8 Weeks"
  },
  {
    ...
    features: ["React Native", "iOS & Android", "App Store Ready", "Push Notifications", "Offline Support"],
    projects: "80+",
    delivery: "6-12 Weeks"
  },
  {
    ...
    features: ["Subscription Billing", "Multi-tenancy", "Analytics Dashboard", "API Integration", "Scalable Infrastructure"],
    projects: "40+",
    delivery: "8-16 Weeks"
  },
  {
    ...
    features: ["Node.js/Python", "Microservices", "REST/GraphQL", "Database Design", "Authentication"],
    projects: "120+",
    delivery: "6-10 Weeks"
  },
  {
    ...
    features: ["Figma/Adobe XD", "Design Systems", "User Research", "Prototyping", "Usability Testing"],
    projects: "90+",
    delivery: "2-4 Weeks"
  },
  {
    ...
    features: ["AWS/Azure/GCP", "Docker/K8s", "CI/CD Pipelines", "Serverless", "Monitoring"],
    projects: "60+",
    delivery: "2-6 Weeks"
  },
  {
    ...
    features: ["Machine Learning", "NLP", "Computer Vision", "Predictive Analytics", "Chatbots"],
    projects: "25+",
    delivery: "8-20 Weeks"
  },
  {
    ...
    features: ["ERP/CRM Integration", "Legacy Migration", "Workflow Automation", "Enterprise Security", "Custom Solutions"],
    projects: "35+",
  ...
  },
  {
    ...
    features: ["Automated Testing", "Performance Testing", "Security Audits", "Manual Testing", "QA Strategy"],
    projects: "100+",
    delivery: "2-4 Weeks"
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 py-32">
        ...
        >
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            ...
            scalable, high-performance digital products with exceptional user experiences.
          </p>
        </motion.div>
...
>
  <div className="relative group">
    <div className={`absolute -inset-0.5 bg-gradient-to-r ${services[activeService].color} rounded-3xl blur opacity-0 group-hover:opacity-30 transition duration-500`} />
          ...
          <div className="flex items-start justify-between mb-6">
            <div>
              <div className="inline-flex p-3 rounded-xl bg-gradient-to-br from-blue-500/10 to-orange-500/10 mb-4">
                {/* Fixed: Extract icon component to variable */}
                {(() => {
                  const IconComponent = services[activeService].icon;
                  return <IconComponent className="w-8 h-8 text-blue-300" />;
                })()}
              </div>
            ...
            <div className="flex gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold">{services[activeService].projects}</div>
                <div className="text-xs text-white/60">Projects</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold">{services[activeService].delivery}</div>
            ...
            <div className="space-y-3">
              {services.map((service, i) => (
                <button
                  ...
                  className={`w-full text-left p-4 rounded-xl transition-all ${i === activeService ? 'bg-white/10' : 'bg-white/5 hover:bg-white/10'}`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      {/* Fixed: Use service.icon directly here since we're in map loop */}
                      {(() => {
                      ...
                      <div>
                        ...
                        <div className="text-xs text-white/60 mt-1">
                          {service.projects} projects • {service.delivery}
                        </div>
                      </div>
                    </div>
                    {i === activeService && (
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {service.features.slice(0, 3).map((feature, idx) => (
                    <span key={idx} className="px-2 py-1 text-xs rounded-lg bg-white/5 border border-white/10">
                      {feature}
                    </span>
                  ))}
                </div>
                ...
                <div className="flex items-center justify-between text-sm">
                  <span className="text-white/60">Delivery: {service.delivery}</span>
          ...
          <div className="glass-card p-8 rounded-3xl backdrop-blur-xl border border-white/10">
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
              {[
                ...
                "Redis", "GraphQL", "React Native", "Flutter", "Figma", "Tailwind CSS",
                "TensorFlow", "FastAPI", "NestJS", "Prisma", "WebSocket", "GitHub Actions"
              ].map((tech, i) => (
                <motion.div
                  key={i}
