// app/backend-api-development-gurgaon/ServiceProcessSection.tsx
'use client';
...
const ServiceProcessSection = () => {
  // Use serviceId 9 for Backend & API Development
  const service = servicesData.find(s => s.id === 9) || servicesData[0] || { process: [] };
