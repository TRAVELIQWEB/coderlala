...
import { CITY } from '@/data/ContactInfo';
...
// ============================================================
// CLIENT LOGOS DATA — alt text no longer hardcoded per entry
// ============================================================
const clientLogos = [
  { id: 1, name: "Aquarius Lab", logo: "/images/client-logo/aquarius-lab.webp", width: 800, height: 800 },
  { id: 2, name: "Jindal Dental Care", logo: "/images/client-logo/jindal-dental-care-and-implant-centre.webp", width: 800, height: 800 },
  { id: 3, name: "Kreative Dentistry", logo: "/images/client-logo/kreative-dentistry.webp", width: 800, height: 800 },
  { id: 4, name: "Mohindra Eco Pipes", logo: "/images/client-logo/mohindra-eco-pipes-logo.webp", width: 800, height: 800 },
  { id: 5, name: "Narain Hospital", logo: "/images/client-logo/narain-hospital.webp", width: 800, height: 800 },
  { id: 6, name: "Webshlok", logo: "/images/client-logo/webshlok.webp", width: 800, height: 800 },
];

interface ClientLogoSliderProps {
  serviceName?: string;   // e.g. "Web Development", "SaaS Development"
  city?: string;          // e.g. "Gurgaon", "Noida"
}
...
const ClientLogoSlider = ({
  ...
  // ✅ Generate accurate, unique alt text per logo, per page context
  const getAltText = (clientName: string) =>
    `${clientName} logo, a ${serviceName} client of CoderLala in ${city}`;
        ...
        {visibleClientLogos.map((client, idx) => (
          ...
          >
            <Image
              key={client.id}
              src={client.logo}
              alt={getAltText(client.name)}   // ✅ dynamic, accurate, per-page
              width={client.width}
