// app/enterprise-software-gurgaon/ServiceProcessSection.tsx
'use client';
...
const ServiceProcessSection = () => {
  // Use serviceId 8 for Enterprise Software
  const service = servicesData.find(s => s.id === 8) || servicesData[0] || { process: [] };
