// app/ai-ml-solutions-gurgaon/ServiceProcessSection.tsx
'use client';
...
const ServiceProcessSection = () => {
  // Use serviceId 7 for AI & ML Solutions
  const service = servicesData.find(s => s.id === 7) || servicesData[0] || { process: [] };
