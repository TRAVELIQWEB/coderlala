...
export default function HeroTitle({ title1, title2 }: { title1: string, title2: string }) {
    return (
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[0.95] mb-4 md:mb-6">
...
export function HeroTitle2({ title1, title2 }: { title1: string, title2: string }) {
    return (
        <>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[0.95] mb-4 sm:mb-6">
