      ...
      <div className="max-w-7xl mx-auto px-4 py-32">
          ...
          <div className="flex flex-wrap gap-3">
            {categories.map((category) => (
              ...
              >
                ...
                <span className={`text-xs px-2 py-1 rounded-full ${activeCategory === category.id ? 'bg-white/20' : 'bg-white/5'}`}>
                  {category.count}
                </span>
              </button>
            ))}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-32">
          {filteredProjects.map((project, index) => (
            ...
            >
              {/* Project Card Glow */}
              <div className={`absolute -inset-0.5 bg-gradient-to-r ${project.color} rounded-3xl blur opacity-0 group-hover:opacity-30 transition duration-500`} />
                ...
                <div className="flex items-center justify-between mt-auto pt-6 border-t border-white/10">
                  ...
                  <div className="flex gap-2">
                    ...
                    {!project.liveUrl && !project.githubUrl && (
                      <div className="p-2 rounded-lg bg-white/5 border border-white/10 cursor-not-allowed" title="Private Project">
