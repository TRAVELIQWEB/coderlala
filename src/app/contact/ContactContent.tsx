        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl !bg-white/5 !border !border-blue-200 focus:border-blue-500 focus:outline-none transition-colors"
              />
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-xl  !bg-white/5 !border !border-blue-200 focus:border-blue-500 focus:outline-none transition-colors resize-none"
            />
          </div>
